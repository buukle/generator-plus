 ...
 * 作者姓名           修改时间           版本号              描述
 */
package top.buukle.generator.commons.status.machine.structure;

import top.buukle.generator.commons.status.machine.model.interfac.AuditStatus;
import top.buukle.generator.commons.status.machine.model.interfac.MasterStatus;
