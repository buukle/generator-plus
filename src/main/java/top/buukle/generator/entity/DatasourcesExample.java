...
public class DatasourcesExample {
    /**
     */
    ...
    /**
     */
    public DatasourcesExample orderBy(String orderByClause) {
    ...
    /**
     */
    public DatasourcesExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        /**
         */
        private DatasourcesExample example;

        /**
         */
        protected Criteria(DatasourcesExample example) {
            super();
        ...
        /**
         */
        public DatasourcesExample example() {
            return this.example;
        }
