...
public class TemplatesExample {
    ...
    /**
     */
    public TemplatesExample orderBy(String orderByClause) {
    ...
    /**
     */
    public TemplatesExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        /**
         */
        private TemplatesExample example;

        /**
         */
        protected Criteria(TemplatesExample example) {
            super();
        ...
        /**
         */
        public TemplatesExample example() {
            return this.example;
        }
