...
public class SystemMonitorUtil {
    ...
    public static String getSystemTotalMemory(){
        SystemInfo systemInfo = new SystemInfo();
        return new DecimalFormat("#.##").format( systemInfo.getHardware().getMemory().getTotal() * 1.0 / 1024 / 1024 / 1024);
    }

    public static String getSystemAvailableMemory(){
        SystemInfo systemInfo = new SystemInfo();
        return new DecimalFormat("#.##").format( systemInfo.getHardware().getMemory().getAvailable() * 1.0 / 1024 / 1024 / 1024);
    }
