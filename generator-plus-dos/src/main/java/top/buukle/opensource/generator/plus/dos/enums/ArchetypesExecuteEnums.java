 ...
 */
public class ArchetypesExecuteEnums {
    ...
    public enum auditStatus {
        ...
        public static String getPairs() {
            ArchetypesExecuteEnums.auditStatus[] values = ArchetypesExecuteEnums.auditStatus.values();
            StringBuffer stringBuffer = new StringBuffer();
            for (ArchetypesExecuteEnums.auditStatus status : values) {
                stringBuffer.append(status.value());
                stringBuffer.append(";");
                stringBuffer.append(status.getDescription());
                stringBuffer.append(",");
