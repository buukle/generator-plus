 ...
 */
public class TemplatesGroupEnums {
    ...
    public enum auditStatus {
        ...
        public static String getPairs() {
            TemplatesGroupEnums.auditStatus[] values = TemplatesGroupEnums.auditStatus.values();
            StringBuffer stringBuffer = new StringBuffer();
            for (TemplatesGroupEnums.auditStatus status : values) {
                stringBuffer.append(status.value());
                stringBuffer.append(";");
                stringBuffer.append(status.getDescription());
                stringBuffer.append(",");
