package top.buukle.opensource.generator.plus.commons.mvc.service;
...
public interface BaseService<MODEL, VO, QUERYDTO,UPDATEDTO> extends IService<MODEL> {
     ...
     * @Date 2021/9/2
     */
    CommonResponse<VO> add(CommonRequest<UPDATEDTO> commonRequest);
     ...
     * @Date 2021/9/2
     */
    CommonResponse<VO> addOrEdit(CommonRequest<UPDATEDTO> commonRequest);
     ...
     * @Date 2021/9/2
     */
    CommonResponse<VO> deleteById(CommonRequest<UPDATEDTO> commonRequest);
     ...
     * @Date 2021/9/2
     */
    CommonResponse<VO> updateById(CommonRequest<UPDATEDTO> commonRequest);
